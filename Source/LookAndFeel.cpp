    ...
    float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider)
{
    ...
    setColour(juce::Slider::rotarySliderOutlineColourId, Colors::Knob::trackBackground);
...
void ButtonLookAndFeel::drawButtonBackground(juce::Graphics& g, juce::Button& button,
    const juce::Colour& backgroundColour, [[maybe_unused]] bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
{
...
void ButtonLookAndFeel::drawButtonText(juce::Graphics& g, juce::TextButton& button, bool shouldDrawButtonAsHighlighted,
